...
- **2026-07-06** — Исправлен TTS-модуль: убран хардкод путей, добавлена обработка ошибок микрофона, graceful shutdown по SIGINT/SIGTERM, таймаут на чтение аудио, нормальные имена переменных, exit codes.
- **2026-07-06** — Добавлен `.gitignore` для Python-проекта.
